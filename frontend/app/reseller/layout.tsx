          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-[11px] text-white/30 mt-1 font-medium">${user?.balance?.toFixed(2) || "0.00"}</p>
              </div>
              <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 text-white flex items-center justify-center font-bold text-sm shadow-lg shadow-blue-500/25 ring-1 ring-white/10">
